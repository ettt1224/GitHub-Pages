...
<head>
    ...
    <title><?php echo e($name); ?> | 2025 雙欄儀表板履歷</title>
    ...
    <div class="flex-1 flex flex-col md:flex-row gap-8 max-w-7xl mx-auto w-full overflow-hidden">
        ...
        <div class="flex-1 flex flex-col gap-6 overflow-hidden">
            ...
            <header class="flex-none">
                ...
                <p class="text-lg text-slate-400 font-medium uppercase tracking-[0.2em]"><?php echo e($title); ?></p>
            </header>
            ...
            <section class="flex-1 glass p-8 rounded-[2rem] flex flex-col justify-between overflow-hidden">
                ...
                <div class="flex-1 flex flex-col justify-around gap-2">
                    ...
                    <div class="flex items-center gap-6 group">
                        ...
                        <div class="flex-1">
                            <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest"><?php echo e($group['category']); ?></p>
                            <p class="text-xl font-black text-white group-hover:text-blue-400 transition"><?php echo e($group['items']); ?></p>
                        </div>
                    </div>
        ...
        <div class="flex-1 flex flex-col gap-6 overflow-hidden">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold"><?php echo e($contact['email']); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                    ...
                    <a href="mailto:<?php echo e($contact['email']); ?>" class="mt-2 py-3 bg-white text-dark text-center font-black rounded-xl hover:bg-blue-400 transition text-sm">
                        立即與我聯繫
                    </a>
                </div>
            </section>
            ...
            <section class="flex-1 glass p-8 rounded-[2rem] flex flex-col overflow-hidden">
                <div class="flex justify-between items-center mb-6 border-b border-purple-500/20 pb-2">
                    ...
                    <a href="<?php echo e($contact['github']); ?>" class="text-[10px] font-bold text-blue-400 hover:text-white transition uppercase">View All ↗</a>
                </div>
                ...
                <div class="flex-1 flex flex-col gap-4 overflow-hidden">
                    ...
                    <div class="flex-1 glass p-5 rounded-2xl border border-white/5 hover:border-blue-500/30 transition flex flex-col justify-center group relative overflow-hidden project-item">
                        ...
                        <h3 class="text-lg font-bold group-hover:text-blue-400 transition"><?php echo e($project['name']); ?></h3>
                        <p class="text-slate-400 text-xs line-clamp-2 leading-relaxed"><?php echo e($project['desc']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </section>
